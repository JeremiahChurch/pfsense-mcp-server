...
# recognizes. Verified against pkg-RESTAPI v2.10.2 (see tests/contract).
_LDAP_URLTYPE = {
    "tcp": "Standard TCP",
...
async def create_auth_server(
    ...
    try:
        ...
        # created. Verified against pkg-RESTAPI v2.10.2 (see tests/contract).
...
async def update_auth_server(
    ...
    try:
        ...
        # names were silently dropped. Verified against pkg-RESTAPI v2.10.2.
        field_map = {
            "name": "name",
            "type": "type",
            "host": "host",

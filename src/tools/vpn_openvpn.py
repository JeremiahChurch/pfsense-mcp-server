...
# historically sent. Verified against pkg-RESTAPI v2.10.2 (see tests/contract):
...
async def manage_openvpn_cso(
    ...
    try:
        ...
        # and custom_options are arrays upstream. Verified against v2.10.2.
        field_map = {
            "common_name": common_name,
...
async def export_openvpn_client_config(
    ...
    try:
        ...
        # against pkg-RESTAPI v2.10.2 (see tests/contract). NOTE: some export
